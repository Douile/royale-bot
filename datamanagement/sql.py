...
class Database(Postgres):
    ...
    def set_server_info(self,server_id,server_name=None,last_help_msg=None,last_help_channel=None,next_shop=None,latest_shop=None,prefix=None):
        print("set_server_info: server_id: {}, server_name: {}, last_help_msg: {}, last_help_channel: {}, next_shop: {}, latest_shop: {}, prefix: {}".format(server_id,server_name,last_help_msg,last_help_channel,next_shop,latest_shop))
