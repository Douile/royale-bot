...
if len(sys.argv) > 2:
    try:
        ...
        pass
VERSION = {'name': BOT_NAME, 'version_name': '1.1.5', 'revison': getEnv('HEROKU_RELEASE_VERSION', 'v1'), 'description': getEnv('HEROKU_SLUG_DESCRIPTION', ''), 'lines': LINE_COUNT, 'shards': SHARD_COUNT}
