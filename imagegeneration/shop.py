...
class CountImage:
    def __init__(self, count):
        ...
        draw = PIL.ImageDraw.Draw(self.background)
        draw.ellipse([(0,0),(self.background.height,self.background.height)],fill=red)
        draw.ellipse([(self.background.width-self.background.height,0),(self.background.width,self.background.height)],fill=red)
        draw.rectangle([(self.background.height,0),(self.background.width-self.background.height,self.background.height)],fill=red)
